...
def get_classification(Matrix, languagevarietyList, Language, modelFolder):
    ...
    ## classification model for language variety prediction
    total1 = 0
...
def get_prediction(Matrix, Language, modelFolder):
    ...
    #print 'Language Variety Predition: ', languagevarietyPrediction
