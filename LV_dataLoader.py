...
''' Input to the load_data function is folder path where the data lies and outputs the
    languagevarietyList     --> language variety class information
...
def load_data(dataFolder, Action):
    ...
    ## creating empty list for appending language variety class information
    ...
    if Action == 'TRAIN':
        ...
        for truthText in truthTexts:
            ...
            if len(truthText) == 3:
                ...
                Data, Language, authorID = LV_xmlParser.get_data(dataFolder, xmlFile)
                languagevarietyList.append(truthText[2])
    ...
    ## loop for loading test data
        ...
        for xmlFile in xmlFiles:
            ...
            languageList.append(Language)
            authorIDList.append(authorID)
    return languagevarietyList, languageList, authorIDList, authorTextList
